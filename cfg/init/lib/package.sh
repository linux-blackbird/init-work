...
MAIN_UTILITY_PACKAGE="git less btop qrencode audacity kitty btop mpd mpc xfmpc hugo obsidian evolution gnome-calendar gnome-calculator"
...
AURS_UTILITY_PACKAGE="visual-studio-code-bin google-chrome"
